                ...
                <div className="mb-20 text-center max-w-4xl mx-auto">
                    <div className="inline-block mb-6">
                        <div className="flex items-center space-x-4">
                            ...
                            <span className="text-xs tracking-[0.3em] uppercase text-stone-500 font-light">Contact</span>
                            <div className="w-12 h-[1px] bg-stone-400"></div>
                        </div>
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-20">
                    {contactMethods.map((method, index) => (
                        ...
                        >
                            ...
                            <div className="absolute inset-0 bg-gradient-to-br from-stone-800 to-stone-900 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>

                            <div className="relative z-10">
                                <div className="w-12 h-12 flex items-center justify-center bg-white/10 backdrop-blur-sm mb-6 group-hover:scale-110 transition-transform duration-500">
                                    <div className="text-stone-600 group-hover:text-white transition-colors duration-500">
                                        {method.icon}
                                    </div>
                                </div>
                                ...
                                {/* Flèche */}
                                <div className="absolute bottom-8 right-8 opacity-0 group-hover:opacity-100 transform translate-x-2 group-hover:translate-x-0 transition-all duration-500">
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                    <div className="relative">
                                        <label htmlFor="name" className="block text-sm font-light text-stone-700 mb-2">
                                            Nom complet
                                        </label>
                                        <input
                                            type="text"
                                        ...
                                        />
                                        <div className={`absolute bottom-0 left-0 h-[2px] bg-stone-900 transition-all duration-300 ${
                                ...
                                {formData.subject === 'reservation' && (
                                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 p-6 bg-white">
                                        <div>
                                            <label htmlFor="checkIn" className="block text-xs font-light text-stone-700 mb-2 uppercase tracking-wider">
                                                Arrivée
                                            </label>
                                            <input
                                                type="date"
                                        ...
                                        <div>
                                            <label htmlFor="checkOut" className="block text-xs font-light text-stone-700 mb-2 uppercase tracking-wider">
                                                Départ
                                            </label>
                                            <input
                                                type="date"
                                        ...
                                        <div>
                                            <label htmlFor="guests" className="block text-xs font-light text-stone-700 mb-2 uppercase tracking-wider">
                                                Voyageurs
                                            </label>
                                            <select
                                                id="guests"
                                ...
                                {/* Message */}
                                <div className="relative">
                                    <label htmlFor="message" className="block text-sm font-light text-stone-700 mb-2">
                                        Votre message
                                    </label>
                                    <textarea
                                        id="message"
                                ...
                                {submitStatus === 'success' && (
                                    <div className="relative overflow-hidden">
                                        <div className="p-6 bg-green-50 border-l-4 border-green-500 animate-slideInUp">
                                            <div className="flex items-start space-x-4">
                                                ...
                                                <div>
                                                    <h3 className="text-green-900 font-medium mb-1">Message envoyé avec succès !</h3>
                                ...
                                >
                                    <span className="relative z-10 text-sm tracking-[0.2em] uppercase font-light flex items-center justify-center space-x-3">
                    ...
                    <div className="lg:col-span-2 space-y-8">
                        ...
                        <div className="bg-stone-50 p-8 lg:p-10">
                            ...
                            <div className="grid grid-cols-3 gap-3">
                                ...
                                >
                                    <svg className="w-6 h-6 text-stone-600 group-hover:text-white transition-colors duration-300" fill="currentColor" viewBox="0 0 24 24">
                                        <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                                    </svg>
                                    <span className="text-xs text-stone-600 group-hover:text-white font-light transition-colors duration-300">Facebook</span>
                                </a>
                                <a
                                ...
                                >
                                    ...
                                    <span className="text-xs text-stone-600 group-hover:text-white font-light transition-colors duration-300">Instagram</span>
                                </a>
                                <a
                                ...
                                >
                                    <svg className="w-6 h-6 text-stone-600 group-hover:text-white transition-colors duration-300" fill="currentColor" viewBox="0 0 24 24">
                                        <path d="M12 0C5.4 0 0 5.4 0 12s5.4 12 12 12 12-5.4 12-12S18.6 0 12 0zm0 22C6.5 22 2 17.5 2 12S6.5 2 12 2s10 4.5 10 10-4.5 10-10 10zm5.9-11.6c-.4-1.3-1.7-2.2-3.1-2.2-1.1 0-2 .5-2.7 1.3-.7-.8-1.6-1.3-2.7-1.3-1.4 0-2.7.9-3.1 2.2-.5 1.6.3 3.3 1.8 4 .5.2.9.3 1.4.3.8 0 1.6-.3 2.2-.8l.4-.4.4.4c.6.5 1.4.8 2.2.8.5 0 .9-.1 1.4-.3 1.5-.7 2.3-2.4 1.8-4z"/>
                                    </svg>
                                    <span className="text-xs text-stone-600 group-hover:text-white font-light transition-colors duration-300">Airbnb</span>
                                </a>
                            </div>
                        </div>

                        {/* Badge de confiance */}
                        <div className="bg-gradient-to-br from-amber-50 to-amber-100/50 p-8 lg:p-10 border border-amber-200/50">
                            <div className="flex items-start space-x-4">
                                <div className="flex-shrink-0">
